...
public class FriendsDao extends AbstractDao<Friends, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Friend_profile_url = new Property(7, String.class, "friend_profile_url", false, "FRIEND_PROFILE_URL");
        public final static Property Sharing = new Property(8, Integer.class, "sharing", false, "SHARING");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRIENDS\" (" + //
                ...
                "\"FRIEND_PROFILE_URL\" TEXT," + // 7: friend_profile_url
                "\"SHARING\" INTEGER);"); // 8: sharing
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Friends entity) {
        ...
        String friend_profile_url = entity.getFriend_profile_url();
        if (friend_profile_url != null) {
            stmt.bindString(8, friend_profile_url);
        }
 
        Integer sharing = entity.getSharing();
        if (sharing != null) {
            stmt.bindLong(9, sharing);
        }
    }
    ...
    public Friends readEntity(Cursor cursor, int offset) {
        Friends entity = new Friends( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // friend_profile_url
            cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8) // sharing
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Friends entity, int offset) {
        ...
        entity.setFriend_profile_url(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setSharing(cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8));
     }
